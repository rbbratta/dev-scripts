...
# Redfish HTTPS BMCs (this lab fork): install-config writes disableCertificateVerification:
# true for Redfish BMCs so BMC TLS pinning / bmcVerifyCA bundles are avoided. Operational
# check against inventory: ./verify_redfish_bmcs.sh
